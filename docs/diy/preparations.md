...
| 器件链接     | 数量 |
|--------| --- |
| [贴片 CH340N SOP-8 USB转串口IC芯片 内置晶振](https://item.taobao.com/item.htm?id=58605175794) | 1 |
...
<mark>如果您购买的显示屏不支持电阻式触控或不具备触控功能，请勿购买本节中的相关器件。</mark>

:::

:::info

NS2009 和 TSC2007 在功能上是相同的，TSC2007 带有硬件滤波器，但价格更贵。在目前测试的几款屏幕中，使用 NS2009 就可以满足需求。
...
| 器件链接     | 颜色分类 | 数量 |
|--------|----------------------| --- |
| [全新原装 NS2009 贴片MSOP10 4线电阻触摸屏控制器芯片，I2C接口](https://item.taobao.com/item.htm?_u=o1m6r7hs6aa9&id=650547292663&spm=a1z09.2.0.0.67002e8dx4F5CY) | 无 | 1                    |

| 器件链接     | 颜色分类 | 数量 |
|--------|----------------------| --- |
| [TSC2007IPWR TSSOP16 进口 TSC2007 模数转换芯片 原装热卖](https://item.taobao.com/item.htm?_u=o1m6r7hs013b&id=530525529861&spm=a1z09.2.0.0.67002e8dx4F5CY) | 无 | 1                    |
...
屏幕的大小和排线的位置有细微的差异，因此需要采用不同的工程设计来进行适配。
#### [RPi_DM_YT350S006]
